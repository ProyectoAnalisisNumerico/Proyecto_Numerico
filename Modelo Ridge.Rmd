...
library(xlsx)
write.xlsx(df_coeficientes, "Coeficientes_ridge.xlsx")
...
El modelo Ridge blablalblablabv 
Por cierto, el modelo ridge tiene la grafica de lineas bonita y la de lasso no mmm.