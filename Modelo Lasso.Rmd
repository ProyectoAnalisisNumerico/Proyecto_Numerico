...
```{r}
plot(real_test, pred_test_real,
     xlab = "Materia orgánica real",
     ylab = "Materia orgánica predicha",
     main = "Real vs Predicho - Modelo LASSO")
abline(0, 1, col = "red")  # Línea perfecta (y = x)
```
